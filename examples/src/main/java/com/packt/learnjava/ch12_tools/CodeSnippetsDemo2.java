 ...
 * javadoc -d ~/apidoc --snippet-path examples/src/main/java/com/packt/learnjava/ch12_tools/snippet-files src/main/java/com/packt/learnjava/ch12_tools/CodeSnippetsDemo2.java
 *
 * Class usage example:
 * {@snippet :
